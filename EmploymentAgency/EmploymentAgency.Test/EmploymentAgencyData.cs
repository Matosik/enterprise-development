    ...
    public EmploymentAgencyData()
    {
        Applicants = [
            new Applicant { IdApplicant = 1,
                        FirstName = "Иван",
                        LastName = "",
                        Birthday = DateOnly.Parse("01.01.2003"),
            ...
            new Applicant {
                        ...
                        FirstName = "Мария",
                        LastName = "Петрова",
                        Birthday = DateOnly.Parse("15.06.1999"),
                        Registration = DateTime.Now,
            ...
            new Applicant {
                        ...
                        FirstName = "Алексей",
                        LastName = "Смирнов",
                        Birthday = DateOnly.Parse("20.12.1990"),
                        Registration = DateTime.Now,
            ...
            new Applicant {
                        ...
                        FirstName = "Ольга",
                        LastName = "Соколова",
                        Birthday = DateOnly.Parse("05.03.1985"),
                        Registration = DateTime.Now,
            ...
            new Applicant {
                    ...
                    FirstName = "Дмитрий",
                    LastName = "Кузнецов",
                    Birthday = DateOnly.Parse("11.11.1995"),
                    Registration = DateTime.Now,
            ...
            new Applicant {
                    ...
                    FirstName = "Елена",
                    LastName = "Новикова",
                    Birthday = DateOnly.Parse("07.07.1992"),
                    Registration = DateTime.Now,
            ...
            new Applicant {
                    ...
                    FirstName = "Антон",
                    LastName = "Киселев",
                    Birthday = DateOnly.Parse("09.09.1988"),
                    Registration = DateTime.Now,
            ...
            new Applicant {
                    ...
                    FirstName = "Юлия",
                    LastName = "Борисова",
                    Birthday = DateOnly.Parse("25.08.2001"),
                    Registration = DateTime.Now,
            ...
            new Applicant {
                    ...
                    FirstName = "Игорь",
                    LastName = "Морозов",
                    Birthday = DateOnly.Parse("17.04.2000"),
                    Registration = DateTime.Now,
            ...
            new Applicant {
                ...
                FirstName = "Александр",
                LastName = "Федоров",
                Birthday = DateOnly.Parse("13.05.1997"),
                Registration = DateTime.Now,
