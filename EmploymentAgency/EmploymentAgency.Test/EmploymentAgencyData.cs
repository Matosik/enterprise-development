    ...
    public EmploymentAgencyData()
    {
        Applicants = [
            new Applicant { IdApplicant = 1,
                        FirstName = "Иван",
                        LastName = "",
                        Birthday = new DateOnly(01,01,2003),
            ...
            new Applicant {
                        ...
                        FirstName = "Мария",
                        LastName = "Петрова",
                        Birthday = new DateOnly(15, 06,1999),
                        Registration = DateTime.Now,
            ...
            new Applicant {
                        ...
                        FirstName = "Алексей",
                        LastName = "Смирнов",
                        Birthday = new DateOnly(20,12,1990),
                        Registration = DateTime.Now,
            ...
            new Applicant {
                        ...
                        FirstName = "Ольга",
                        LastName = "Соколова",
                        Birthday = new DateOnly(05,03,1985),
                        Registration = DateTime.Now,
            ...
            new Applicant {
                    ...
                    FirstName = "Елена",
                    LastName = "Новикова",
                    Birthday = new DateOnly(07,07,1992),
                    Registration = DateTime.Now,
            ...
            new Applicant {
                    ...
                    FirstName = "Юлия",
                    LastName = "Борисова",
                    Birthday = new DateOnly(25,08,2001),
                    Registration = DateTime.Now,
            ...
            new Applicant {
                    ...
                    FirstName = "Игорь",
                    LastName = "Морозов",
                    Birthday = new DateOnly(17,04,2000),
                    Registration = DateTime.Now,
            ...
            new Applicant {
                ...
                FirstName = "Александр",
                LastName = "Федоров",
                Birthday = new DateOnly(13,05,1997),
                Registration = DateTime.Now,
